...
public class MainFrame extends JFrame {
    ...
    public MainFrame(Double[] coefficients) {
        ...
        JMenu helpMenu = new JMenu("Справка"); // Добавлено меню "Справка"
        menuBar.add(helpMenu);

        Action aboutAction = new AbstractAction("О программе") {
            public void actionPerformed(ActionEvent event) {
                JOptionPane.showMessageDialog(MainFrame.this,
                        "Автор: Дятчик Владимир\nГруппа 7",
                        "О программе",
    ...
    public static void main(String[] args) {
        if (args.length == 0) {
            JOptionPane.showMessageDialog(null, "Введите коэффициенты многочлена в командной строке",
                    "Ошибка", JOptionPane.ERROR_MESSAGE);
            System.exit(1);
        }
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Ошибка ввода коэффициентов: " + e.getMessage(),
                    "Ошибка", JOptionPane.ERROR_MESSAGE);
            System.exit(1);
        }
